...
import { ICashier, Cashier } from 'app/shared/model/cashier.model';
...
describe('Service Tests', () => {
    describe('Cashier Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Cashier(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA');
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should update a Cashier', async () => {
                const returnedFromService = Object.assign(
                    {
                        firstName: 'BBBBBB',
                        lastName: 'BBBBBB',
            ...
            it('should return a list of Cashier', async () => {
                const returnedFromService = Object.assign(
                    {
                        firstName: 'BBBBBB',
                        lastName: 'BBBBBB',
