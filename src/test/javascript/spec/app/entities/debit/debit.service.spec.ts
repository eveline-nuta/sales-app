...
import { IDebit, Debit } from 'app/shared/model/debit.model';
...
describe('Service Tests', () => {
    describe('Debit Service', () => {
        ...
        let elemDefault: IDebit;
        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [HttpClientTestingModule]
            });
            injector = getTestBed();
            service = injector.get(DebitService);
            httpMock = injector.get(HttpTestingController);

            elemDefault = new Debit(0, 'AAAAAAA', 0, false);
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should return a list of Debit', async () => {
                const returnedFromService = Object.assign(
                    {
                        transactionId: 'BBBBBB',
                        moneyAmount: 1,
